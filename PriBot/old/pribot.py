...
FORMAT_DEFINITIONS = [
    {'id': 1, 'name': '診療費請求書兼領収書(A4)', 'page': 1, 'line': 1, 'pattern': '診療費請求書兼領収書\n診療日', 'use_rect': True, 'x0': 0, 'y0': 440, 'x1': 400, 'y1': 460},
    {'id': 2, 'name': '診療費請求書兼領収書(A4控え付き)', 'page': 1, 'line': 1, 'pattern': '診療費請求書兼領収書\nNo.', 'use_rect': True, 'x0': 45, 'y0': 375, 'x1': 155, 'y1': 395},
    {'id': 3, 'name': '診療費請求書兼領収書(A5)', 'page': 1, 'line': 1, 'pattern': '診療費請求書兼領収書\n患者番号', 'use_rect': True, 'x0': 300, 'y0': 140, 'x1': 530, 'y1': 150},
    ...
    {'id': 6, 'name': '薬袋シール', 'page': 1, 'line': 2, 'pattern': '_処__方__日__', 'use_rect': False, "clinic_name_line": -2},
...
def find_matching_hospital(pdf_info, hospital_list):
    ...
    try:
        ...
        for hospital in hospital_list:
            ...
            # 医療機関名がPDFのクリニック名に含まれているかチェック
            if hospital_name in clinic_name:
